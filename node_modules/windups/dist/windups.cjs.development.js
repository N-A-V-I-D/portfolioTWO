...
function useWindup(windupInit, options) {
  ...
  var nextCharAtRef = React.useRef(null);
  var pauseDelayRemainingRef = React.useRef(null);
  var isPausedRef = React.useRef(false);
...
function useRewind() {
  var _React$useContext4 = React.useContext(WindupContext),
      rewind = _React$useContext4.rewind;

  return rewind;
}
function useIsFinished() {
  var _React$useContext5 = React.useContext(WindupContext),
